...
const slides = [
  {
    title: "শিল্প ও সংস্কৃতির পীঠস্থান",
    subtitle: "বুলবুল ললিতকলা একাডেমীতে স্বাগতম",
    description: "সংগীত, নৃত্য, চিত্রকলা ও অভিনয়ে দক্ষতা অর্জন করুন আমাদের অভিজ্ঞ শিক্ষকদের তত্ত্বাবধানে।",
    icon: Palette,
    image: heroBg1,
  },
  {
